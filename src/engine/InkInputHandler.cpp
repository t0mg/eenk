...
void InkInputHandler::handleCommonNavigation(bool isStoryEnded, InkEngine& engine, InkDisplayManager& display, InkStoryManager& story, class IDisplay& IDisplay, struct AppSettings& settings, IFrontlight* frontlight, BatteryWidget* batteryWidget) {
...
void InkInputHandler::tickWaitingInput(InkEngine& engine, InkDisplayManager& display, InkStoryManager& story, class IDisplay& IDisplay, struct AppSettings& settings, IFrontlight* frontlight, BatteryWidget* batteryWidget) {
  handleCommonNavigation(false, engine, display, story, IDisplay, settings, frontlight, batteryWidget);
}
...
void InkInputHandler::tickStoryEnded(InkEngine& engine, InkDisplayManager& display, InkStoryManager& story, class IDisplay& IDisplay, struct AppSettings& settings, IFrontlight* frontlight, BatteryWidget* batteryWidget) {
  handleCommonNavigation(true, engine, display, story, IDisplay, settings, frontlight, batteryWidget);
}
